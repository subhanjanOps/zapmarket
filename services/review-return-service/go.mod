...
require (
	...
	github.com/zapmarket/zapmarket/pkg/database v0.0.0-00010101000000-000000000000
	github.com/zapmarket/zapmarket/pkg/logger v0.0.0-00010101000000-000000000000
	github.com/zapmarket/zapmarket/pkg/migrate v0.0.0-00010101000000-000000000000
)
