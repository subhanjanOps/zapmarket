...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  if (sellerStatus !== "APPROVED") {
    return (
      <div style={{ minHeight: "100dvh", display: "flex", alignItems: "center", justifyContent: "center", background: "var(--bg)", flexDirection: "column", gap: "1.5rem", padding: "2rem", textAlign: "center" }}>
        ...
        <button onClick={() => { clearToken(); router.replace("/login"); }} className="btn btn-ghost">
          Sign out
        </button>
      </div>
    );
  ...
  return (
    <div style={{ display: "flex", minHeight: "100dvh" }}>
      ...
      <aside className="dash-drawer" style={{
        position: "fixed",
        top: 0,
        left: 0,
        height: "100dvh",
      ...
      <style>{`
        /* Tablet and mobile: hide desktop sidebar, show topbar + bottom nav */
        ...
        /* Tablet: show sidebar but slightly narrower */
